var FailScreen = {
    ...
    create : function() {
      ...
      this.restartButton = game.add.button(game.world.centerX - 100,game.world.centerY+50, 'imgRestartButton', function() { return this.restartLevel(game.levelSelected);}, this, 1,0);
      this.restartButton.anchor.setTo(0.5,0.5);

      this.homeButton = game.add.button(game.world.centerX + 100, game.world.centerY+50, 'imgHomeButton', function() {return this.startScreen();}, this,1,0);
