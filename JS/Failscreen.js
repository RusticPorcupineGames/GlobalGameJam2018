var FailScreen = {
    ...
    create : function() {
      ...
      this.restartButton = game.add.button(game.world.centerX,game.world.centerY, 'imgRestartButton', function() { return this.restartLevel(game.levelSelected);}, this, 1,0);
