...
function getLevel(number) {
    ...
    case 1:
        return [
            ...
            ['e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e'],
            ['e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e', 'e'],
            ['p', 'p', 'p', 'p', 'tilepurpledoorNWwallRHS', 'tilepurpledoorNW', 'tilepurpledoorNWwallLHS', 'p', 'p',
                'p', 'p', 'p'
            ],
    ...
    case 4:
        return [
            ...
            ['p', 'c', 'p', 'p', 'p', 'tilepurpledoorNWwallRHS', 'tilepurpledoorNW', 'tilepurpledoorNWwallLHS', 'p',
                'p', 'c', 'p'
            ],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
    ...
    case 5:
        return [
            ...
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'b', 'b', 'c', 'c', 'b', 'b', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'd', 'b', 'c', 'c', 'd', 'b', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'd', 'b', 'c', 'c', 'p'],
            ['p', 'c', 'b', 'b', 'b', 'b', 'b', 'd', 'b', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'b', 'c', 'b', 'c', 'b', 'c', 'p'],
            ['p', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'p'],
            ['p', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p']
        ];
    ...
    case 6:
        return [
            ['p', 'tilepurpledoorNWwallRHS', 'tilepurpledoorNW', 'tilepurpledoorNWwallLHS', 'p', 'p', 'p', 'p',
                'tilepurpledoorNWwallRHS', 'tilepurpledoorNW', 'tilepurpledoorNWwallLHS', 'p'
            ],
