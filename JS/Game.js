...
Game.Boot.prototype =
{
  ...
  create: function () {
    ...
    this.homeButton = game.add.button(1050, 470, 'imgHomeButton2', function(){ return this.goToHome();}, this, 1,0);
    this.restartButton = game.add.button(50, 480, 'imgRestartButton2', function(){ return this.restartLevel();}, this, 1,0);
